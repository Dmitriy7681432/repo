...
class Main(QMainWindow):
    def __init__(self,cur_elem):
        ...
        self.buttonAction4 = QToolButton()
        self.buttonAction4.setText('Открыть')
        self.buttonAction1.setFont(font)
        self.buttonAction2.setFont(font)
        self.buttonAction3.setFont(font)
        self.buttonAction4.setFont(font)
        ...
        self.buttonAction4.setMaximumSize(QtCore.QSize(300, 50))
        ...
        self.buttonAction4.setObjectName("buttonAction4")
        ...
        self.buttonAction4.setStyleSheet('background-color:rgb(255,240,157);')
        ...
        for i, v in enumerate(self.lst_cb):
            if i ==0:
                ...
                # self.buttonAction4.clicked.connect(self.openData_bu1)
            elif i ==1:
                ...
                # self.buttonAction4.clicked.connect(self.openData_bu2)
            else:
                ...
                # self.buttonAction4.clicked.connect(self.openData_bu3)
