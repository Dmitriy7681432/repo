...
// Дата и время обновления: 19.06.2024 13:14
...
#define KEY_EP323 ((uint32_t)(305))
// Низкий уровень топлива бака 1
#define KEY_EP002 ((uint32_t)(306))
// Низкий уровень топлива бака 2
#define KEY_EP002_2 ((uint32_t)(307))
// КЗ(отключен) автомат Подзаряд АБ ХД
#define KEY_EP234 ((uint32_t)(308))
// Пожар
#define KEY_LIM_FIRE ((uint32_t)(309))
// Сработало РБП
#define KEY_LIM_RBP ((uint32_t)(310))
// Аварийный останов
#define KEY_LIM_AV_OST ((uint32_t)(311))
// Низкое напряжение АКБ ХД
#define KEY_LIM_U_AB_SHASSIS ((uint32_t)(312))
// Низкое напряжение АКБ
#define KEY_LIM_U_AB_STARTER ((uint32_t)(313))
// Предупреждение: низкое напряжение АКБ
#define KEY_LIM_U_AB_STARTER_MANUAL ((uint32_t)(314))
// ИВЭП норма
#define KEY_LIM_STATUS_IVEP_NORM ((uint32_t)(315))
// ИВЭП НЕ норма
#define KEY_LIM_STATUS_IVEP_NO_NORM ((uint32_t)(316))
// Автомат Q17 (Подзаряд АБ ХД)
#define KEY_LIM_AB_SHASSIS_AUT_OP ((uint32_t)(317))
// Не cработало РБП
#define KEY_LIM_RBP_OFF ((uint32_t)(318))
...
// Сработало МКИ
#define KEY_LIM_MKI ((uint32_t)(1302))
// Контроль включения контактора МКИ
#define KEY_LIM_WAIT_KMKI_ON ((uint32_t)(1303))
// Контроль отключения контактора МКИ
#define KEY_LIM_WAIT_KMKI_OFF ((uint32_t)(1304))
...
#define KEY_LIM_WRONG_PHASING ((uint32_t)(2316))
// Контроль включения контактора сети 1
#define KEY_LIM_WAIT_KN_ON ((uint32_t)(2317))
// Контроль отключения контактора сети 1
#define KEY_LIM_WAIT_KN_OFF ((uint32_t)(2318))
// U фазы AB выше нормы
#define KEY_LIM_N_U_AB_HIGH ((uint32_t)(2319))
// U фазы AB ниже нормы
#define KEY_LIM_N_U_AB_LOW ((uint32_t)(2320))
// U фазы BC выше нормы
#define KEY_LIM_N_U_BC_HIGH ((uint32_t)(2321))
// U фазы BC ниже нормы
#define KEY_LIM_N_U_BC_LOW ((uint32_t)(2322))
// U фазы AC выше нормы
#define KEY_LIM_N_U_AC_HIGH ((uint32_t)(2323))
// U фазы AC ниже нормы
#define KEY_LIM_N_U_AC_LOW ((uint32_t)(2324))
// Частота AB выше нормы
#define KEY_LIM_N_FAB_HIGH ((uint32_t)(2325))
// Частота BC выше нормы
#define KEY_LIM_N_FBC_HIGH ((uint32_t)(2326))
// Частота CA выше нормы
#define KEY_LIM_N_FCA_HIGH ((uint32_t)(2327))
// Частота AB ниже нормы
#define KEY_LIM_N_FAB_LOW ((uint32_t)(2328))
// Частота BC выше нормы
#define KEY_LIM_N_FBC_LOW ((uint32_t)(2329))
// Частота CA выше нормы
#define KEY_LIM_N_FCA_LOW ((uint32_t)(2330))
// Обрыв одной из фаз
...
#define KEY_LIM_P_N_MAX ((uint32_t)(2339))
...
// U фазы AB выше нормы
#define KEY_LIM_EA_U_AB_HIGH ((uint32_t)(5324))
// U фазы BC выше нормы
#define KEY_LIM_EA_U_BC_HIGH ((uint32_t)(5325))
// U фазы AC выше нормы
#define KEY_LIM_EA_U_AC_HIGH ((uint32_t)(5326))
// U фазы AB ниже нормы
#define KEY_LIM_EA_U_AB_LOW ((uint32_t)(5327))
// U фазы BC ниже нормы
#define KEY_LIM_EA_U_BC_LOW ((uint32_t)(5328))
// U фазы AC ниже нормы
#define KEY_LIM_EA_U_AC_LOW ((uint32_t)(5329))
// Низкое давление масла
#define KEY_LIM_EA_P_OIL_MIN ((uint32_t)(5330))
// Пониженное давление масла
#define KEY_LIM_EA_P_OIL_LOW ((uint32_t)(5331))
// Температура ОЖ выше нормы (перегрев ОЖ)
#define KEY_LIM_EA_T_COOL_HIGH ((uint32_t)(5332))
// Температура ОЖ ниже нормы
#define KEY_LIM_T_LIQ_HIGH_400 ((uint32_t)(5333))
// Температура масла выше нормы (перегрев масла)
#define KEY_LIM_EA_T_OIL_HIGH ((uint32_t)(5334))
// Частота выше нормы
#define KEY_LIM_EA_F_HIGH ((uint32_t)(5335))
// Частота ниже нормы
#define KEY_LIM_EA_F_LOW ((uint32_t)(5336))
// Разнос
#define KEY_LIM_EA_F_BREAK ((uint32_t)(5337))
// Контроль включения контактора ЭА
#define KEY_LIM_WAIT_KEA_ON ((uint32_t)(5338))
// Контроль отключения контактора ЭА
#define KEY_LIM_WAIT_KEA_OFF ((uint32_t)(5339))
// Перегруз 50 % по току фазы А
#define KEY_LIM_EA_I_A_150 ((uint32_t)(5340))
// Перегруз 50 % по току фазы B
#define KEY_LIM_EA_I_B_150 ((uint32_t)(5341))
// Перегруз 50 % по току фазы C
#define KEY_LIM_EA_I_C_150 ((uint32_t)(5342))
// КЗ в фазе A
#define KEY_LIM_EA_I_A_SHORT ((uint32_t)(5343))
// КЗ в фазе B
#define KEY_LIM_EA_I_B_SHORT ((uint32_t)(5344))
// КЗ в фазе C
#define KEY_LIM_EA_I_C_SHORT ((uint32_t)(5345))
// Перегруз по мощности ЭА
#define KEY_LIM_P_EA ((uint32_t)(5346))
// Требование ТО
#define KEY_LIM_EA_MOTOHOURS_TO_END ((uint32_t)(5347))
// Перегруз по мощности ЭА выше max
#define KEY_LIM_P_EA_MAX ((uint32_t)(5348))
// Не норма ур. ОЖ
#define KEY_LIM_EA_LEVEL ((uint32_t)(5349))
// Перегрев заднего подшипника ЭА
#define KEY_LIM_RBEA_TEMP ((uint32_t)(5350))
// Перегрев переднего подшипника ЭА
#define KEY_LIM_FBEA_TEMP ((uint32_t)(5351))
// Перегрев генератора ЭА
#define KEY_LIM_EA_TEMP ((uint32_t)(5352))
// Засоренность воздушного фильтра
#define KEY_LIM_FILTER ((uint32_t)(5353))
// Сброс аварии Температура ОЖ ниже нормы
#define KEY_LIM_T_LIQ_HIGH_400_RESET ((uint32_t)(5354))

// Агрегат EA2

// U линейное AB сырое
#define KEY_EA_U_AB_RAW ((uint32_t)(6300))
// U линейное BC сырое
#define KEY_EA_U_BC_RAW ((uint32_t)(6301))
// U линейное AC сырое
#define KEY_EA_U_AC_RAW ((uint32_t)(6302))
// F U фазы A сырое
#define KEY_EA_F_U_A_RAW ((uint32_t)(6303))
// F U фазы B сырое
#define KEY_EA_F_U_B_RAW ((uint32_t)(6304))
// F U фазы C сырое
#define KEY_EA_F_U_C_RAW ((uint32_t)(6305))
// I фазы A сырое
#define KEY_EA_I_A_RAW ((uint32_t)(6306))
// I фазы B сырое
#define KEY_EA_I_B_RAW ((uint32_t)(6307))
// I фазы C сырое
#define KEY_EA_I_C_RAW ((uint32_t)(6308))
// t охлаждающей жидкости сырое
#define KEY_EA_t_COOL_RAW ((uint32_t)(6309))
// P масла сырое
#define KEY_EA_P_OIL_RAW ((uint32_t)(6310))
// t масла сырое
#define KEY_EA_t_OIL_RAW ((uint32_t)(6311))
// F U фазы U2 сырое
#define KEY_EA_F_U_A2_RAW ((uint32_t)(6312))
// U линейное AB2 сырое
#define KEY_EA_U_AB2_RAW ((uint32_t)(6313))
...
// Отказ НЗТ
#define KEY_EA350 ((uint32_t)(23314))
// Отказ контактора НЗТ
#define KEY_EP006 ((uint32_t)(23315))
...
#define KEY_LIM_WAIT_RFP_ON ((uint32_t)(23316))
// Контроль отключения реле НЗТ
#define KEY_LIM_WAIT_RFP_OFF ((uint32_t)(23317))
// Аварийный уровень топлива бака 1
#define KEY_LIM_ALARM_FUEL_TANK1 ((uint32_t)(23318))
// Аварийный уровень топлива бака 2
#define KEY_LIM_ALARM_FUEL_TANK2 ((uint32_t)(23319))
// Низкий уровень топлива бака 1
#define KEY_LIM_LOW_LEVEL_FUEL_TANK1 ((uint32_t)(23320))
// Низкий уровень топлива бака 2
#define KEY_LIM_LOW_LEVEL_FUEL_TANK2 ((uint32_t)(23321))
...
// Отказ люка забора 1
#define KEY_EA340 ((uint32_t)(24307))
...
// Авария корректора возбуждения ПЧ 1
#define KEY_ALARM_CORRECTOR_FC1 ((uint32_t)(32041))
// Контактор питания АД ПЧ 1
...
// Составной параметр аварий ПЧ 2 на БУ400
...
// Отказ корректора возбуждения ПЧ 1
#define KEY_EA561 ((uint32_t)(32122))
...
#define KEY_LIM_WAIT_KAE_ON ((uint32_t)(32329))
// Контроль отключения контактора питания АД ПЧ
#define KEY_LIM_WAIT_KAE_OFF ((uint32_t)(32330))
// Контроль включения контактора питания АД ПЧ звездой
#define KEY_LIM_WAIT_KAE_STAR_ON ((uint32_t)(32331))
// Контроль отключения контактора питания АД ПЧ звездой
#define KEY_LIM_WAIT_KAE_STAR_OFF ((uint32_t)(32332))
// Контроль включения контактора питания АД ПЧ треугольником
#define KEY_LIM_WAIT_KAE_TRIANGLE_ON ((uint32_t)(32333))
// Контроль отключения контактора питания АД ПЧ треугольником
#define KEY_LIM_WAIT_KAE_TRIANGLE_OFF ((uint32_t)(32334))
// Превышение номинального тока АД ПЧ1 в 1,5 раза по фазе А
#define KEY_LIM_FC1_A_OVERLOAD ((uint32_t)(32335))
// Превышение номинального тока АД ПЧ1 в 1,5 раза по фазе B
#define KEY_LIM_FC1_B_OVERLOAD ((uint32_t)(32336))
// Превышение номинального тока АД ПЧ1 в 1,5 раза по фазе C
#define KEY_LIM_FC1_C_OVERLOAD ((uint32_t)(32337))
// Превышение номинального тока АД ПЧ1 в 2,5 раза по фазе А
#define KEY_LIM_FC1_A_SHORT ((uint32_t)(32338))
// Превышение номинального тока АД ПЧ1 в 2,5 раза по фазе B
#define KEY_LIM_FC1_B_SHORT ((uint32_t)(32339))
// Превышение номинального тока АД ПЧ1 в 2,5 раза по фазе C
#define KEY_LIM_FC1_C_SHORT ((uint32_t)(32340))
// Контроль включения контактора ПЧ
#define KEY_LIM_WAIT_KFC1_ON ((uint32_t)(32341))
// Контроль отключения контактора ПЧ
#define KEY_LIM_WAIT_KFC1_OFF ((uint32_t)(32342))
// Контроль включения контактора объединения шин ПЧ
#define KEY_LIM_WAIT_KFC1_BUS_ON ((uint32_t)(32343))
// Контроль отключения контактора объединения шин ПЧ
#define KEY_LIM_WAIT_KFC1_BUS_OFF ((uint32_t)(32344))
// Контроль включения контактора МКИ ПЧ
#define KEY_LIM_WAIT_KFC1_MKI_ON ((uint32_t)(32345))
// Контроль отключения контактора МКИ ПЧ
#define KEY_LIM_WAIT_KFC1_MKI_OFF ((uint32_t)(32346))
// Сработало МКИ ПЧ
#define KEY_LIM_FC1_MKI ((uint32_t)(32347))
// Контроль включения реле снятия возбуждения ПЧ
#define KEY_LIM_WAIT_ON_FC1_FIELD_OFF ((uint32_t)(32348))
// Контроль отключения реле снятия возбуждения ПЧ
#define KEY_LIM_WAIT_OFF_FC1_FIELD_OFF ((uint32_t)(32349))
// Контроль включения реле самовозбуждения ПЧ
#define KEY_LIM_WAIT_ON_FC1_SELF_EXCITATION ((uint32_t)(32350))
// Контроль отключения реле самовозбуждения ПЧ
#define KEY_LIM_WAIT_OFF_FC1_SELF_EXCITATION ((uint32_t)(32351))
// Контроль включения реле корректора ПЧ
#define KEY_LIM_WAIT_ON_FC1_CORRECTOR ((uint32_t)(32352))
// Контроль отключения реле корректора ПЧ
#define KEY_LIM_WAIT_OFF_FC1_CORRECTOR ((uint32_t)(32353))
// Отказ корректора ПЧ
#define KEY_LIM_ALARM_CORRECTOR_FC1 ((uint32_t)(32354))
// U фазы A выше нормы
#define KEY_LIM_FC1_U_A_HIGH ((uint32_t)(32355))
// U фазы B выше нормы
#define KEY_LIM_FC1_U_B_HIGH ((uint32_t)(32356))
// U фазы C выше нормы
#define KEY_LIM_FC1_U_C_HIGH ((uint32_t)(32357))
// U фазы A ниже нормы
#define KEY_LIM_FC1_U_A_LOW ((uint32_t)(32358))
// U фазы B ниже нормы
#define KEY_LIM_FC1_U_B_LOW ((uint32_t)(32359))
// U фазы C ниже нормы
#define KEY_LIM_FC1_U_C_LOW ((uint32_t)(32360))
// U фазы A выше верхнего предела
#define KEY_LIM_FC1_U_A_TOO_HIGH ((uint32_t)(32361))
// U фазы B выше верхнего предела
#define KEY_LIM_FC1_U_B_TOO_HIGH ((uint32_t)(32362))
// U фазы C выше верхнего предела
#define KEY_LIM_FC1_U_C_TOO_HIGH ((uint32_t)(32363))
// U фазы A ниже нижнего предела
#define KEY_LIM_FC1_U_A_TOO_LOW ((uint32_t)(32364))
// U фазы B ниже нижнего предела
#define KEY_LIM_FC1_U_B_TOO_LOW ((uint32_t)(32365))
// U фазы C ниже нижнего предела
#define KEY_LIM_FC1_U_C_TOO_LOW ((uint32_t)(32366))
// F U фазы A выше нормы
#define KEY_LIM_FC1_F_U_A_HIGH ((uint32_t)(32367))
// F U фазы B выше нормы
#define KEY_LIM_FC1_F_U_B_HIGH ((uint32_t)(32368))
// F U фазы C выше нормы
#define KEY_LIM_FC1_F_U_C_HIGH ((uint32_t)(32369))
// F U фазы A ниже нормы
#define KEY_LIM_FC1_F_U_A_LOW ((uint32_t)(32370))
// F U фазы B ниже нормы
#define KEY_LIM_FC1_F_U_B_LOW ((uint32_t)(32371))
// F U фазы C ниже нормы
#define KEY_LIM_FC1_F_U_C_LOW ((uint32_t)(32372))
// Обрыв одной из фаз ПЧ1
#define KEY_LIM_BREAK_WIRE_400_1 ((uint32_t)(32373))
// Перегруз по току 50 % ПЧ1
#define KEY_LIM_FC1_GEN_I_A_OVERLOAD ((uint32_t)(32374))
// Перегруз по току 50 % ПЧ1
#define KEY_LIM_FC1_GEN_I_B_OVERLOAD ((uint32_t)(32375))
// Перегруз по току 50 % ПЧ1
#define KEY_LIM_FC1_GEN_I_C_OVERLOAD ((uint32_t)(32376))
// КЗ ПЧ1
#define KEY_LIM_FC1_GEN_I_A_SHORT ((uint32_t)(32377))
// КЗ ПЧ1
#define KEY_LIM_FC1_GEN_I_B_SHORT ((uint32_t)(32378))
// КЗ ПЧ1
#define KEY_LIM_FC1_GEN_I_C_SHORT ((uint32_t)(32379))
// Запускается ПЧ100 1
#define KEY_LIM_FC1_STARTING ((uint32_t)(32380))
// Запускается ПЧ100 1
#define KEY_LIM_FC1_ON_OFF ((uint32_t)(32381))
...
#define KEY_EA500_2 ((uint32_t)(33325))
// Напряжение ПЧ2 ниже нормы
#define KEY_EA501_2 ((uint32_t)(33326))
// Неверная фазировка сети 400 Гц
#define KEY_EA502_2 ((uint32_t)(33327))
// Обрыв фаз сети 400 Гц
#define KEY_EA503_2 ((uint32_t)(33328))
// Частота ПЧ2 ниже нормы
#define KEY_EA507_2 ((uint32_t)(33329))
// Частота ПЧ2 выше нормы
#define KEY_EA508_2 ((uint32_t)(33330))
// КЗ ПЧ2
#define KEY_EA519_2 ((uint32_t)(33331))
// Напряжение ПЧ2 выше верхнего предела
#define KEY_EA520_2 ((uint32_t)(33332))
// Напряжение ПЧ2 ниже нижнего предела
#define KEY_EA521_2 ((uint32_t)(33333))
// Неисправность контактора питания АД ПЧ2
#define KEY_EA550_2 ((uint32_t)(33334))
// Перегруз ПЧ2 по мощности
#define KEY_EP525_2 ((uint32_t)(33335))
// Неисправность контактора питания АД ПЧ2 звездой
#define KEY_EA551_2 ((uint32_t)(33336))
// Неисправность контактора питания АД ПЧ2 треугольником
#define KEY_EA552_2 ((uint32_t)(33337))
// Неисправность контактора ПЧ2
#define KEY_EA554_2 ((uint32_t)(33338))
// Неисправность контактора объединения шин ПЧ2
#define KEY_EA555_2 ((uint32_t)(33339))
// Неисправность контактора МКИ ПЧ2
#define KEY_EA556_2 ((uint32_t)(33340))
// Неисправность реле снятия возбуждения ПЧ2
#define KEY_EA557_2 ((uint32_t)(33341))
// Неисправность реле статизма для параллельной работы ПЧ
#define KEY_EA558_2 ((uint32_t)(33342))
// Неисправность реле начального возбуждения ПЧ2
#define KEY_EA559_2 ((uint32_t)(33343))
// Срабатывание МКИ ПЧ 2
#define KEY_EA560_2 ((uint32_t)(33120))
// Отказ корректора возбуждения ПЧ2
#define KEY_EA561_2 ((uint32_t)(33344))
// Неудачный пуск АД ПЧ 2. Невыход на пусковой ток
#define KEY_EA562_2 ((uint32_t)(33345))
// Неудачный пуск АД ПЧ 2. Пропало напряжение источника
#define KEY_EA563_2 ((uint32_t)(33346))
// Неудачный пуск АД ПЧ 2. Невыход на ток холостого хода
#define KEY_EA564_2 ((uint32_t)(33347))
// Превышение I АД ПЧ 2 150%
#define KEY_EP565_2 ((uint32_t)(33348))
// Превышение I АД ПЧ 2 250%
#define KEY_EA566_2 ((uint32_t)(33349))
// Контроль включения контактора питания АД ПЧ2
#define KEY_LIM_WAIT_KAE2_ON ((uint32_t)(33350))
// Контроль отключения контактора питания АД ПЧ2
#define KEY_LIM_WAIT_KAE2_OFF ((uint32_t)(33351))
// Контроль включения контактора питания АД ПЧ2 звездой
#define KEY_LIM_WAIT_KAE2_STAR_ON ((uint32_t)(33352))
// Контроль отключения контактора питания АД ПЧ2 звездой
#define KEY_LIM_WAIT_KAE2_STAR_OFF ((uint32_t)(33353))
// Контроль включения контактора питания АД ПЧ2 треугольником
#define KEY_LIM_WAIT_KAE2_TRIANGLE_ON ((uint32_t)(33354))
// Контроль отключения контактора питания АД ПЧ2 треугольником
#define KEY_LIM_WAIT_KAE2_TRIANGLE_OFF ((uint32_t)(33355))
// Превышение номинального тока АД ПЧ2 в 1,5 раза по фазе А
#define KEY_LIM_FC2_A_OVERLOAD ((uint32_t)(33356))
// Превышение номинального тока АД ПЧ2 в 1,5 раза по фазе B
#define KEY_LIM_FC2_B_OVERLOAD ((uint32_t)(33357))
// Превышение номинального тока АД ПЧ2 в 1,5 раза по фазе C
#define KEY_LIM_FC2_C_OVERLOAD ((uint32_t)(33358))
// Превышение номинального тока АД ПЧ2 в 2,5 раза по фазе А
#define KEY_LIM_FC2_A_SHORT ((uint32_t)(33359))
// Превышение номинального тока АД ПЧ2 в 2,5 раза по фазе B
#define KEY_LIM_FC2_B_SHORT ((uint32_t)(33360))
// Превышение номинального тока АД ПЧ2 в 2,5 раза по фазе C
#define KEY_LIM_FC2_C_SHORT ((uint32_t)(33361))
// Контроль включения контактора ПЧ2
#define KEY_LIM_WAIT_KFC2_ON ((uint32_t)(33362))
// Контроль отключения контактора ПЧ2
#define KEY_LIM_WAIT_KFC2_OFF ((uint32_t)(33363))
// Контроль включения контактора объединения шин ПЧ2
#define KEY_LIM_WAIT_KFC2_BUS_ON ((uint32_t)(33364))
// Контроль отключения контактора объединения шин ПЧ2
#define KEY_LIM_WAIT_KFC2_BUS_OFF ((uint32_t)(33365))
// Контроль включения контактора МКИ ПЧ2
#define KEY_LIM_WAIT_KFC2_MKI_ON ((uint32_t)(33366))
// Контроль отключения контактора МКИ ПЧ2
#define KEY_LIM_WAIT_KFC2_MKI_OFF ((uint32_t)(33367))
// Сработало МКИ ПЧ2
#define KEY_LIM_FC2_MKI ((uint32_t)(33368))
// Контроль включения реле снятия возбуждения ПЧ2
#define KEY_LIM_WAIT_ON_FC2_FIELD_OFF ((uint32_t)(33369))
// Контроль отключения реле снятия возбуждения ПЧ2
#define KEY_LIM_WAIT_OFF_FC2_FIELD_OFF ((uint32_t)(33370))
// Контроль включения реле самовозбуждения ПЧ2
#define KEY_LIM_WAIT_ON_FC2_SELF_EXCITATION ((uint32_t)(33371))
// Контроль отключения реле самовозбуждения ПЧ2
#define KEY_LIM_WAIT_OFF_FC2_SELF_EXCITATION ((uint32_t)(33372))
// Контроль включения реле корректора ПЧ2
#define KEY_LIM_WAIT_ON_FC2_CORRECTOR ((uint32_t)(33373))
// Контроль отключения реле корректора ПЧ2
#define KEY_LIM_WAIT_OFF_FC2_CORRECTOR ((uint32_t)(33374))
// Отказ корректора ПЧ2
#define KEY_LIM_ALARM_CORRECTOR_FC2 ((uint32_t)(33375))
// U фазы A выше нормы
#define KEY_LIM_FC2_U_A_HIGH ((uint32_t)(33376))
// U фазы B выше нормы
#define KEY_LIM_FC2_U_B_HIGH ((uint32_t)(33377))
// U фазы C выше нормы
#define KEY_LIM_FC2_U_C_HIGH ((uint32_t)(33378))
// U фазы A ниже нормы
#define KEY_LIM_FC2_U_A_LOW ((uint32_t)(33379))
// U фазы B ниже нормы
#define KEY_LIM_FC2_U_B_LOW ((uint32_t)(33380))
// U фазы C ниже нормы
#define KEY_LIM_FC2_U_C_LOW ((uint32_t)(33381))
// U фазы A выше верхнего предела
#define KEY_LIM_FC2_U_A_TOO_HIGH ((uint32_t)(33382))
// U фазы B выше верхнего предела
#define KEY_LIM_FC2_U_B_TOO_HIGH ((uint32_t)(33383))
// U фазы C выше верхнего предела
#define KEY_LIM_FC2_U_C_TOO_HIGH ((uint32_t)(33384))
// U фазы A ниже нижнего предела
#define KEY_LIM_FC2_U_A_TOO_LOW ((uint32_t)(33385))
// U фазы B ниже нижнего предела
#define KEY_LIM_FC2_U_B_TOO_LOW ((uint32_t)(33386))
// U фазы C ниже нижнего предела
#define KEY_LIM_FC2_U_C_TOO_LOW ((uint32_t)(33387))
// F U фазы A выше нормы
#define KEY_LIM_FC2_F_U_A_HIGH ((uint32_t)(33388))
// F U фазы B выше нормы
#define KEY_LIM_FC2_F_U_B_HIGH ((uint32_t)(33389))
// F U фазы C выше нормы
#define KEY_LIM_FC2_F_U_C_HIGH ((uint32_t)(33390))
// F U фазы A ниже нормы
#define KEY_LIM_FC2_F_U_A_LOW ((uint32_t)(33391))
// F U фазы B ниже нормы
#define KEY_LIM_FC2_F_U_B_LOW ((uint32_t)(33392))
// F U фазы C ниже нормы
#define KEY_LIM_FC2_F_U_C_LOW ((uint32_t)(33393))
// Обрыв одной из фаз ПЧ
#define KEY_LIM_BREAK_WIRE_400_2 ((uint32_t)(33394))
// Перегруз по току 50 % ПЧ2
#define KEY_LIM_FC2_GEN_I_A_OVERLOAD ((uint32_t)(33395))
// Перегруз по току 50 % ПЧ2
#define KEY_LIM_FC2_GEN_I_B_OVERLOAD ((uint32_t)(33396))
// Перегруз по току 50 % ПЧ2
#define KEY_LIM_FC2_GEN_I_C_OVERLOAD ((uint32_t)(33397))
// КЗ ПЧ2
#define KEY_LIM_FC2_GEN_I_A_SHORT ((uint32_t)(33398))
// КЗ ПЧ2
#define KEY_LIM_FC2_GEN_I_B_SHORT ((uint32_t)(33399))
// КЗ ПЧ2
#define KEY_LIM_FC2_GEN_I_C_SHORT ((uint32_t)(33400))
// Запускается ПЧ100 2
#define KEY_LIM_FC2_STARTING ((uint32_t)(33401))
// Индикация останова, аварии  ПЧ100 2
#define KEY_LIM_FC2_ON_OFF ((uint32_t)(33402))
